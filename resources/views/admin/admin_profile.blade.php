                                ...
                                <form class="forms-sample" action=" {{ url('admin_profile/update') }} " method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="Username"
                                            name= "username" value="{{ $getRecord->username }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Phone</label>
                                        <input type="phone" class="form-control" id="" placeholder="Phone"
                                            name= "phone" value="{{ $getRecord->phone }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Email address</label>
                                        <input type="email" class="form-control" id="" placeholder="Email"
                                            name= "email" value="{{ $getRecord->email }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" id="" placeholder="About" name="about"
                                            value="{{ $getRecord->about }}"></textarea>

                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Website</label>
                                        <input type="text" class="form-control" id="" placeholder="Website"
                                            name= "website" value="{{ $getRecord->website }}">
                                    </div>
